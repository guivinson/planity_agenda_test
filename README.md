...
1. transformation to add infos (uncesssary as this)
2. organize events into a grid to get a representation in a bidimensionnal array
   1. solution chosen for a better readability / debug capacity but which needs to generate a grid with a defined granularity (TIME_TICK)
3. convert the array into a displayed agenda
